...
A curated portfolio of Python-based projects focused on CLI tools, data analytics, data cleaning, log processing, and modular software design.
...
- `src/` for source code  
- `data/` or `logs/` for input files  
- `output/` for generated reports  
- `README.md` for documentation  

## About

This repository showcases my ability to build real-world Python applications with clean architecture, persistent storage, data processing pipelines, log analysis tools, and professional documentation.
